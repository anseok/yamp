...
# phplex module v0.2.2014-04-01
# Author: Anseok Joo (anseok at gmail dot com)
# Public Domain

# This module implements PHP lexer and unlexer using the PHP Tokenizer
# extension.  It also defines sets of tokens of common properties and
# default immutables based on PHP documentation.
...
# customisables ########################################################
_php = '/usr/bin/php'  # path to PHP CLI binary

# constants ############################################################
# tokens containing identifiers
id = frozenset(('T_STRING', 'T_STRING_VARNAME', 'T_VARIABLE'))
# tokens for keywords preceding class & public method identifiers
imm_prefix = frozenset(('T_CLASS', 'T_PUBLIC'))
# tokens to skip
skip = frozenset((
  'T_END_HEREDOC', 'T_COMMENT', 'T_DOC_COMMENT',
  'T_ML_COMMENT', 'T_START_HEREDOC', 'T_WHITESPACE'))
# tokens that can contain newlines
nl = frozenset((
  'T_CLOSE_TAG', 'T_COMMENT', 'T_CONSTANT_ENCAPSED_STRING',
  'T_DOC_COMMENT', 'T_ENCAPSED_AND_WHITESPACE', 'T_INLINE_HTML',
  'T_ML_COMMENT', 'T_OPEN_TAG', 'T_OPEN_TAG_WITH_ECHO',
  'T_START_HEREDOC', 'T_STRING'))
# tokens with alphanum as the leftmost char
left = frozenset((
  'T_ABSTRACT', 'T_ARRAY', 'T_AS', 'T_BREAK', 'T_CALLABLE', 'T_CASE',
  'T_CATCH', 'T_CLASS', 'T_CLASS_C', 'T_CLONE', 'T_CONST', 'T_CONTINUE',
  'T_DECLARE', 'T_DEFAULT', 'T_DIR', 'T_DNUMBER', 'T_DO', 'T_ECHO',
  'T_ELSE', 'T_ELSEIF', 'T_EMPTY', 'T_ENDDECLARE', 'T_ENDFOR',
  'T_ENDFOREACH', 'T_ENDIF', 'T_ENDSWITCH', 'T_ENDWHILE', 'T_EVAL',
  'T_EXIT', 'T_EXTENDS', 'T_FILE', 'T_FINAL', 'T_FINALLY', 'T_FOR',
  'T_FOREACH', 'T_FUNCTION', 'T_FUNC_C', 'T_GLOBAL', 'T_GOTO',
  'T_HALT_COMPILER', 'T_IF', 'T_IMPLEMENTS', 'T_INCLUDE',
  'T_INCLUDE_ONCE', 'T_INSTANCEOF', 'T_INSTEADOF', 'T_INTERFACE',
  'T_ISSET', 'T_LINE', 'T_LIST', 'T_LNUMBER', 'T_LOGICAL_AND',
  'T_LOGICAL_OR', 'T_LOGICAL_XOR', 'T_METHOD_C', 'T_NAMESPACE',
  'T_NS_C', 'T_NEW', 'T_NUM_STRING', 'T_PRINT', 'T_PRIVATE', 'T_PUBLIC',
  'T_PROTECTED', 'T_REQUIRE', 'T_REQUIRE_ONCE', 'T_RETURN', 'T_STATIC',
  'T_STRING', 'T_STRING_VARNAME', 'T_SWITCH', 'T_THROW', 'T_TRAIT',
  'T_TRAIT_C', 'T_TRY', 'T_UNSET', 'T_USE', 'T_VAR', 'T_WHILE',
  'T_YIELD'))
# tokens with alphanum as the rightmost char
right = left | frozenset(('T_END_HEREDOC', 'T_VARIABLE'))

# PHP Tokenizer code
_lex = """
function printToken($t)
{ if (is_string($t)): $name = 'SINGLE'; $value = $t;
  else: $name = token_name($t[0]); $value = $t[1]; endif;
...
# functions ############################################################
def lex(filename):
  'lex a file and return a tuple of (token name, value) pairs'
  return eval(subprocess.check_output(
      [_php, '-r', _lex, '--', filename]))

def unlex(tokens, filename):
  'write a tuple of (token name, value) pairs to a file as PHP code'
  with open(filename, 'w') as f:
    for t in tokens: f.write(t[1])

# default immutables ###################################################
defaults = frozenset(s.lower() for s in (
# predefined classes listed in
...
'static',
'parent',
# predefined constants listed in
...
'xattr',
'xdiff',
# function aliases listed in
# http://www.php.net/manual/en/aliases.php
'_',
'add',
'add_root',
'addaction',
...
'unlink',
'xptr_new_context',
# builtin functions and methods listed in
